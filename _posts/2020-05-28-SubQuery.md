...
Q6. 30번 부서의 직원의 평균 월급보다 더 많이 받는 사원의 이름, 월급, 부서번호를 추출해서
TEST04 테이블을 생성하자.
~~~ SQL
CREATE TABLE TEST04 
AS 
...
### 데이터 딕셔너리
 ...
 : user_xxxxx형식으 ㅣ데이터 딕셔너리에 접근 가능
...
Q14. TEST07 테이블을 생성하고 NO, NAME을 추가하자
NO NUMBER   ...   PK  ...> 식별 데이터가 존재하고 있어야 함
...
#### 조건 
1. 컬럼 데이터 타입 확인 : 대상컬럼의 데이터가 비어있는 경우만 해당(NULL 포함)
